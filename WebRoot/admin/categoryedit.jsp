			...
			<form class="layui-form col-lg-4" id="categoryform" method="post" action="<%=path %>/admin/categoryEdit.do" onsubmit="return categoryadd()">
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">  
					  	<input type="text" name="name" id="name"  value="${category.name}" required oninvalid="setCustomValidity('图书类别名称不能为空')" oninput="setCustomValidity('');"  style="width: 300px;"  autocomplete="off"  class="layui-input" placeholder="图书类别名称" >
					</div>
				</div>
