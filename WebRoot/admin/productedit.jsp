		...
		<div class="larry-personal-body clearfix changepwd">
			...
			<input type="hidden" name="id" value="${product.id}"/>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block" style="width: 300px;">  
					  	<select name="mid" id="mid" style="width: 300px;" lay-verify="required" lay-filter="mid"   autocomplete="off"  class="layui-input">
					  	  <option value="${prodcut.mid}" >${product.mcategory.name}</option>
					  	</select>
					</div>
				</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">  
					  	<textarea id="editor_id" name="content" style="width: 600;height: 280px;" placeholder="请输入图书介绍" required class="layui-textarea" oninvalid="setCustomValidity('图书介绍不能为空')" oninput="setCustomValidity('');" >${product.content}</textarea>
					</div>
				</div>
