		...
		<div class="larry-personal-body clearfix changepwd">
			<form class="layui-form col-lg-4" id="supplierform" method="post" action="<%=path %>/admin/newsAdd.do" onsubmit="return supplieradd()">
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">  
					  	<textarea  id="editor_id" name="content" style="width: 600;height: 280px;" placeholder="新闻内容" class="layui-textarea" oninvalid="setCustomValidity('请输入新闻内容')" oninput="setCustomValidity('');" ></textarea>
					</div>
				</div>
